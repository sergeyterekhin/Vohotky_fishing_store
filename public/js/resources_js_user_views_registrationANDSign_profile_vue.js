  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_0__.mapActions)({
    ...
    signOut: function signOut() {
      ...
      this.signOutAction().then(function () {
        _this.$route.name != "Home" ? _this.$router.replace({
          name: 'Home'
    ...
    submit: function submit() {
      ...
      this.changeUserData(this.form).then(function () {
        _this2.bflag = false;
        _this2.showRegistrationform = true;
      })["catch"](function (e) {
        _this2.bflag = false;
...
var render = function () {
  ...
  var _c = _vm._self._c || _h
  return _c("main", [
    _c("div", { attrs: { id: "mobile_user_nav" } }, [
      _c("ul", [
        _c(
          "li",
          [
            _c("router-link", { attrs: { to: "/info/about" } }, [
              _vm._v("Об этом магазине"),
            ]),
          ],
          1
        ),
    ...
    _c("form", { staticClass: "forms" }, [
      ...
      _c("div", { staticClass: "item" }, [
        _c(
          ...
          [
            !_vm.bflag
              ? _c("div", [_vm._v("Сохранить изменения")])
